...
export default function SideBarSecure(){
    return (
        ...
        <NavLink className="block px-4 py-2 mt-2 text-sm font-semibold text-white hover:bg-gray-600"
          to="dashboard"><i className="fas fa-tachometer-alt text-lg mr-3"></i> Tableau de bord</NavLink>
        <NavLink className="block px-4 py-2 mt-2 text-sm font-semibold text-white hover:bg-gray-600"
          to="article"><i className="fas fa-box text-lg mr-3"></i> Articles
        </NavLink>
        <NavLink className="block px-4 py-2 mt-2 text-sm font-semibold text-white hover:bg-gray-600"
          to="dette"><i className="fas fa-dollar-sign text-lg mr-3"></i>Dettes
        </NavLink>
        <NavLink className="block px-4 py-2 mt-2 text-sm font-semibold text-white hover:bg-gray-600"
          to="client"><i className="fas fa-users text-lg mr-3"></i>Clients
        </NavLink>
        <NavLink className="block px-4 py-2 mt-2 text-sm font-semibold text-white hover:bg-gray-600"
          to="user"><i className="fas fa-user text-lg mr-3"></i>Utilisateur
        </NavLink>
        <NavLink className="block px-4 py-2 mt-2 text-sm font-semibold text-white hover:bg-gray-600"
          to="demande"><i className="fas fa-envelope text-lg mr-3"></i>Demandes
        </NavLink>
     </div>
    )
}